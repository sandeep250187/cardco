    ...
    <div class="transfer-search">
      <div>
        <div class="row text-center">
          <h1 class="headings">Add Package</h1>
        </div>
        <div class="form-horizontal">
          <form name="register" id="register" method="post" action="#" novalidate="novalidate">
            <div class="col-sm-4">
              <div class="form-group">
                <div class="col-xs-3">
                  ...
                  <div class="form-control-static"> <strong class="text-warning">Malaysia</strong> </div>
                </div>
                <div class="col-xs-3">
                  <label for="inputEmail">City</label>
                  <div class="form-control-static"> <strong class="text-warning">Penang</strong> </div>
                </div>
                <div class="col-xs-3">
                  <label class="">Adult</label>
                  <div class="form-control-static"> <strong class="text-warning"><?php echo $_GET['adult'];  ?></strong> </div>
                </div>
                <div class="col-xs-3">
                  <label class="">Child</label>
                  <div class="form-control-static"> <strong class="text-warning"><?php echo $_GET['cwb'];  ?></strong> </div>
                </div>
              </div>
              <div class="form-group">
                <div class="col-xs-3">
                  <label for="inputEmail">Checkin Date</label>
                  <div class="form-control-static"> <strong class="text-warning"><?php echo $_GET['cindate'];  ?></strong> </div>
                </div>
                <div class="col-xs-3">
                  <label for="inputEmail">Checkout Date</label>
                  <div class="form-control-static"> <strong class="text-warning">
                    <?php
                ...
                <div class="col-xs-3">
                  <label class="">No Of Night</label>
                  <div class="form-control-static"> <strong class="text-warning"><?php echo $_GET['night'];  ?></strong> </div>
                </div>
                <div class="col-xs-3">
                  <label class=""> </label>
                </div>
            ...
            <div class="form-group">
              <div class="col-md-4">
                <select type="search" name="rt1" class="form-control searchbox1" required>
                  <option value="2" <?php if(2==$_REQUEST['rt2']) echo 'selected="selected"'; ?>>Single</option>
                </select>
              </div>
              <div class="col-md-4">
                <select type="search" name="rc1" class="form-control searchbox1" required>
                  <?php
											$select_cat1=mysql_query("select * from apmg_hotel_tariff_withoutshtl_rooming where pid='$_GET[id]' and room_type='1'");
											while($fetch_cat1=mysql_fetch_array($select_cat1))
											{?>
                  <option value="<?php echo $fetch_cat1['room_cat'];  ?>" <?php if($fetch_cat1['room_cat']==$_REQUEST['rc1']) echo 'selected="selected"'; ?>>
                  <?php $rc=$fetch_cat1['room_cat'];  
                ...
                <select type="search" name="nroom2" onchange="change();" class="form-control searchbox1" required>
                  ...
                  <?php		
											for($i=0;$i<20;$i++)	
												{			
											?>
                  <option value="<?php echo $i; ?>" <?php if($i==$_REQUEST['nroom2']) echo 'selected="selected"'; ?>><?php echo $i; ?></option>
                  <?php			}			?>
                </select>
              </div>
            </div>
              ...
              <div class="col-md-4">
                <select type="search" name="rc2" class="form-control searchbox1" required>
                  <?php
											...
											{?>
                  <option value="<?php echo $fetch_cat2['room_cat'];  ?>" <?php if($fetch_cat2['room_cat']==$_REQUEST['rc2']) echo 'selected="selected"'; ?>>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <select type="search" name="rc3" class="form-control searchbox1" required>
                  <?php
											...
											{?>
                  <option value="<?php echo $fetch_cat3['room_cat'];  ?>" <?php if($fetch_cat3['room_cat']==$_REQUEST['rc3']) echo 'selected="selected"'; ?>>
              ...
              <div class="col-md-4">
                <select type="search" name="nroom3" onchange="change();" class="form-control searchbox1" required>
                  <?php		
											for($i=0;$i<20;$i++)	
												{			
											?>
                  <option value="<?php echo $i; ?>" <?php if($i==$_REQUEST['nroom3']) echo 'selected="selected"';?>><?php echo $i; ?></option>
                  <?php			}			?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-md-4">
                <select type="search" name="rt3" class="form-control searchbox1" required>
                  <option value="3" <?php if(3==$_REQUEST['rt3']) echo 'seleted="selected"'; ?>>Family</option>
                </select>
              </div>
              <div class="col-md-4">
                <select type="search" name="rc4" class="form-control searchbox1" required>
                  <?php
											...
											{?>
                  <option value="<?php echo $fetch_cat4['room_cat'];  ?>" <?php if($fetch_cat4['room_cat']==$_REQUEST['rc4']) echo 'selected="selected"'; ?>>
                  ...
                  <select type="search" name="ext_night" class="form-control searchbox1" required>
                    ...
                    <?php		
											for($i=0;$i<20;$i++)	
												{			
											?>
                    <option value="<?php echo $i; ?>" <?php if($i==$_REQUEST['ext_night']) echo 'selected="selected"'; ?>><?php echo $i; ?></option>
                    <?php			}			?>
                  </select>
                </div>
              </div>
            ...
            <div class="form-group text-right">
              ...
              <div class="col-sm-12">
                <?php 
								   ...
								   ?>
                <h4> Total  Booking Cost: <span class="text-warning">
                  <?php   $fetch_rate['twin_rate'];?>
                  </span></h4>
                ...
                <table class="table table-bordered table-condensed additional-table">
                  ...
                  <tr bgcolor="#fff">
                    <td align="center"><strong><?php echo $_REQUEST['nroom2'];?></strong></td>
                    <td align="center"><strong>USD <?php echo $fetch_rate['twin_rate']; ?></strong></td>
                  ...
                  <?php
												...
												?>
                  <tr bgcolor="#fff">
                    <td align="center"><strong><?php echo $_REQUEST['nroom3'];?></strong></td>
                    <td align="center"><strong>USD <?php echo $fetch_rate['triple_rate']; ?></strong></td>
                    <td align="center"><strong>Triple sharing</strong></td>
                  ...
                  <tr bgcolor="#fff">
                    ...
                    <td align="center"><strong>Double Sharing</strong></td>
                    <td align="center"><strong>USD <?php echo $_REQUEST['ext_nroom2']*$fetch_rate['exn_twinrate']; ?></strong></td>
                  </tr>
                  <?php
												}
												}
              ...
              <div class="col-sm-6">
                <button type="submit" name="save" value="Add" class="btn btn-primary book-now1 btn-block">Add </button>
              </div>
              <?php
									}
