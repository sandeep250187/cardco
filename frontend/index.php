...
<div class="row slider">
    <div id="carousel-example" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active"> <img src="images_home/banner.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption ">
                    <a href="#"> Enjoy up to 65% off with member-only rates. Tell me more</a>
                </div>
            </div>
            <div class="carousel-item"> <img src="images_home/banner1.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption ">
                    <a href="#">  Enjoy up to 65% off with member-only rates. Tell me more</a>
                </div>
            </div>
            <div class="carousel-item"> <img src="images_home/banner2.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption ">
                    <a href="#">  Enjoy up to 65% off with member-only rates. Tell me more</a>
                </div>
            </div>
                        ...
                        <div class="transfer-search">
                            <div class="col-md-8 offset-md-2 p-0">
                                <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a href="#hotel" class="nav-item nav-link active" data-toggle="tab"><i class="fa fa-hotel"></i><span class="d-none d-sm-block"> Hotel</span></a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <!-- <li class="nav-item">
                                        <a href="#car" class="nav-item nav-link" data-toggle="tab"><i class="fa fa-car"></i> <span class="d-none d-sm-block">Cars</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#home" class="nav-item nav-link" data-toggle="tab"><i class="fa fa-home"></i> <span class="d-none d-sm-block">Vacation Homes</span></a>
                                    </li> -->
                                    <li class="nav-item">
                            ...
                            <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    <div class="row">
                                                        <div class="col-sm-6 pr-1 pl-1">
                                                            <div class="styled-select-small">
                                                                <div class="position-absolute"><i class="fa fa-search"></i></div>
                                                                <input type="search" class="form-control" placeholder="Pick up" name="">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6 pr-1 pl-1">
                                                            <div class="styled-select-small">
                                                                <div class="position-absolute"><i class="fa fa-search"></i></div>
                                                                <input type="search" class="form-control" placeholder="same as Pickup" name="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-2 pr-1 pl-1">
                                                            <button type="submit" name="submit" class="btn btn-primary btn-search search-transfer  btn-block">Search Car</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="homes-tab">
                                    <form name="input1" action="transfer-list.php" method="POST">
                                        <div class="selection clearfix">
                                            <div class="row">
                                                <div class="col-sm-3 pr-1 pl-1">
...
<div class="container ">
    ...
    <div class="tiles">
        <a class="tile" href="#">
            <img src="images_home/penang1.jpg"/>
...
<a class="tile" href="#">
    <img src="images_home/penang2.jpg"/>
    <div class="details"><span class="title">Save Up to 65% With Last Minute Travel Club</span><span class="info">Save more with exclusive discounts that only members have access to. Plus, gain access to our loyalty program, where you can earn points toward a free hotel stay!<br>
    <button type="" class="btn btn-danger btn-sm">Join Now</button>
</span>
</div></a>
<a class="tile" href="#">
<img src="images_home/penang3.jpg"/>
<div class="details"><span class="title">Save Up to 65% With Last Minute Travel Club</span><span class="info">Save more with exclusive discounts that only members have access to. Plus, gain access to our loyalty program, where you can earn points toward a free hotel stay!<br>
<button type="" class="btn btn-danger btn-sm">Join Now</button>
</span>
</div>
...
<a class="tile" href="#">
<img src="images_home/penang4.jpg"/>
<div class="details"><span class="title">Save Up to 65% With Last Minute Travel Club</span><span class="info">Save more with exclusive discounts that only members have access to. Plus, gain access to our loyalty program, where you can earn points toward a free hotel stay!<br>
<button type="" class="btn btn-danger btn-sm">Join Now</button>
</span>
</div>
...
<div class="grid row">
<div class="col-sm-4">
<figure class="effect-box "> <img src="images_home/trending1.jpg" alt="img13">
<figcaption>
<h2>Attractions  <br>
...
<div class="col-sm-4">
<figure class="effect-box"> <img src="images_home/trending2.jpg" alt="img13">
<figcaption>
...
<div class="col-sm-4">
<figure class="effect-box"> <img src="images_home/trending3.jpg" alt="img13">
<figcaption>
<h2>(Penang Attractions)   <br>
...
<div class="col-sm-4">
<figure class="effect-box"> <img src="images_home/trending4.jpg" alt="img13">
<figcaption>
<h2>Attractions <br>
...
<div class="col-sm-4">
<figure class="effect-box"> <img src="images_home/trending5.jpg" alt="img13">
<figcaption>
<h2>Attractions <br>
...
<div class="col-sm-4">
<figure class="effect-box"> <img src="images_home/trending6.jpg" alt="img13">
<figcaption>
<h2>(Penang Attractions)   <br>
