 <?php include "include/header.php";   $d=date('Y/m/d'); ?>
  ...
  <form name="frm" action="hotel-search-wout.php" method="POST"> 
 ...
 <h4>Search Hotel</h4>
       ...
       <li><label>Location :</label>
           ...
           <li><label>Date :</label><input type="text" value="<?php echo $d; ?>" class="form-control" id="date_from" name="cd">
          </li>		  
          <li>   <label>Night :</label>                      <select type="night" name="night" class="form-control searchbox1">                	<?php							for($i=6;$i<=6;$i++)							{							?>							<option value="<?php echo $i; ?>" <?php echo ($_POST['adult']==$i)?'selected="selected"' : '' ?> ><?php echo $i; ?></option>                   <?php							}				   ?>              </select>           </li>
         <!-- <li>
          <label>Adult :</label>
          <select type="search" name="adult" class="form-control searchbox1" required>                      				<?php							for($i=1;$i<41;$i++)							{							?>							<option value="<?php echo $i; ?>" <?php echo ($_POST['adult']==$i)?'selected="selected"' : '' ?> ><?php echo $i; ?></option>                   <?php							}				   ?>                        </select>                                           </li>
           <li>
           <label>Child :</label>
           <select type="search" name="child" class="form-control searchbox1" required> <?php							for($i=0;$i<41;$i++)							{							?>							<option value="<?php echo $i; ?>" <?php echo ($_POST['adult']==$i)?'selected="selected"' : '' ?> ><?php echo $i; ?></option>                   <?php							}				   ?>                        </select>                                           </li>-->
           <li><label>&nbsp;</label>
    ...
    <div id="carousel-example" class="carousel slide carousel-fade" data-ride="carousel"> 
      ...
      <!-- Controls --> 
      <a class="left carousel-control" href="#carousel-example" role="button" data-slide="prev"> <span class="sr-only">Previous</span><i class="glyphicon glyphicon-chevron-left"></i> </a> <a class="right carousel-control" href="#carousel-example" role="button" data-slide="next"> <span class="sr-only">Next</span><i class="glyphicon glyphicon-chevron-right"></i>  </a> 
      </div>
  </div>
