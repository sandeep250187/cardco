...
<?php
                    $to='';
        $select_detail=mysql_query("select * from apmg_order_detail_tour where order_id='$_GET[id]' and cusid='$_SESSION[id]'");
...
<li class="col-sm-2"><img src="http://aatg.work/my/upload/<?php echo $row1['pic'];  ?>" class="img-responsive cart-thumbnail"></li>
<li class="col-sm-7">
  <h4>
    <?php
                 echo $data['tt'];echo "&nbsp"; echo $data['vehicle_name'];
                  
                  ?>
  </h4>
  <ul class="list-unstyled">
     <li><strong><?php echo $data['type']; ?> </strong></li>
    <li><strong><?php echo $data['adult']; ?> Adults</strong></li>
    <li><strong><?php echo $data['child']; ?> Childs</strong></li>
  </ul>
</li>
<li class="col-sm-3 text-right">
  <h4 class="text-success"> <i class="fa fa-building"></i> Tour</h4>
      ...
      <div class="table-responsive">
        <table class="table table-condensed">
          <tbody>
            ...
            <tr>
              <td class="services ">Tour Total Price</td>
