                    ...
                    <div>
                        <ul class="nav nav-tabs nav-justified">
                            <li class="active"><a href="#A" data-toggle="tab">Search Transfers</a></li>
                             <li><a  href="#B" data-toggle="tab">Search Tours </a></li> 
                        </ul>
                        <!-- Tab panes -->
                    </div>
		...
		<option value="3">Railway Station</option>
	   	   ...
	   	   <option value="5">Venue</option>
                                    ...
                                    <div class="row">
										...
										<div class="col-sm-12 text-center"><br><div class="book-now offer">
                                        <button type="submit" name="submit" class="btn btn-primary  btn-search">Search Transfer</button>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="styled-select-small"> <label>Adult:</label>
                                                ...
                                                <select type="search" name="adult" class="form-control searchbox1" required>                          <option value="">Select Adult</option>							<?php							for($i=1;$i<14;$i++)							{							?>							<option value="<?php echo $i; ?>" <?php echo ($_POST['adult']==$i)?'selected="selected"' : '' ?> ><?php echo $i; ?></option>                   <?php							}				   ?>                        </select>
                                            </div>
                                        </div>
                                       
                                        <div class="col-sm-6">
                                            <div class="styled-select-small"> <label>Child:</label>
                                               <select type="search" name="child" class="form-control searchbox1" required>                          <option value="">Select Adult</option>							<?php							for($i=1;$i<14;$i++)							{							?>							<option value="<?php echo $i; ?>" <?php echo ($_POST['adult']==$i)?'selected="selected"' : '' ?> ><?php echo $i; ?></option>                   <?php							}				   ?>                        </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
