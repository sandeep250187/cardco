   ...
   <p>Adult <strong><?php echo $_REQUEST['adult']; ?></strong> , Child <strong><?php echo $_REQUEST['child']; ?></strong></p>
      ...
      <form type="search" method="POST" action="" class="searchs">
       ...
       <li><label>Location :</label>
          ...
          <li><label>Checkin Date :</label><div class="dates"><input type="text" value="<?php echo $_REQUEST['cd']; ?>" class="form-control" id="from-date" autocomplete="off" name="cd" required>
          </div>
          </li>	<li><label>CheckOut Date :</label><div class="dates"><input type="text" value="<?php echo $_REQUEST['cod']; ?>" class="form-control" id="to-date" autocomplete="off" name="cod" required></div>
          </li>		  
