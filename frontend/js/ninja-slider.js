...
function NinjaSlider(a) {
            ...
            if (b.lL === undefined) {
                ...
                if (l[e]) {
                    ...
                    if (a) {
                        ...
                        if (E(a, "data-fs-image")) { b.nIs = [i, E(a, "data-fs-image")]; if (K(k, "fullscreen")) i = b.nIs[1] }
                        if (i) b.nI = a;
                        else b.lL = 0;
                        var f = new Image;
        ...
        tb = function(e, p) {
            ...
            if (p == 9) C(b[0], "sl-0");
                ...
                var n = !h && k.offsetWidth == f[y].offsetWidth ? "2" : "",
                    g = e - c;
                if (!a.rewind) { if (!e && c == r - 1) g = 1; if (!c && e != 1 && e == r - 1) g = -1 }
                if (g == 1) {
                    o(b[c], "sl-cl" + n);
                    o(b[e], "sl-sl" + n)
                } else if (g == -1) {
            ...
            if (a.d) {
                ...
                S = m(function() { tb(e + 1, 0) }, b[e].dL + s)
            }
            b[e].player && mb(b[e]);
    ...
    ub.prototype = {
        ...
        c: function() {
            ...
            d && this.b();
            if (a.c != "slide" && !h && a.m) { var g = r; while (g--) x(b[g], "animationend", Gb) }
        },
        d: function() {
            if (a.g.indexOf(":") != -1) {
                var b = a.g.split(":");
        ...
        addNavs: function() {
            ...
            if (f[e]) {
                ...
                x(j, "keydown", function(a) { a.keyCode == 27 && K(k, "fullscreen") && f.click() })
            }
        },
        sliderId: t,
        stop: M,
    ...
    var V = function() { k = j.getElementById(t); if (k) { var a = db(k, "ul"); if (a[e]) p = new ub(a[0]) } },
        Rb = function(c) {
            var a = 0;
