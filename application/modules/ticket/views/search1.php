...
?>
							...
							<div class="cbp-vm-details">
								...
								<p class="location1 m-0">
									Description:-<?php echo substr($value['description'],0,50); ?> <a href="#" data-toggle="modal" data-target="#exampleModal<?php echo $num; ?>">Read More</a></p>
							</div>
							<!-- Modal -->
					...
					?>
								...
								?> <?php  echo round($adata,2); ?>/<?php echo $p[name]; ?>Per Pax								</h3>
					   <?php } ?>
								<a class="cbp-vm-icon cbp-vm-add btn btn-outline-danger btn-sm" href="javascript:void(0);" onclick="book_ticket(<?php echo $value['id']; ?>);">Book Now</a>
								
							</div>

                               <div class="modal fade" id="modaladdtour<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" style="height:200px;" role="document">
		 <div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="pp_tname"><?php echo $value['title'];?></h5>
				...
				<div class="modal-body">
                          ...
                          <tr>
						   ...
						   <?php $pdata=google_money_convert($re['currency'],'MYR',$re['price']);  echo round($pdata,2); ?>
...
{
	  $('#modaladdtour'+ticket_id).modal('show');
}
</script>