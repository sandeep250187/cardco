            ...
            <div class="col-sm-9">
                <form type="search" method="GET" action="" class="searchs">
                    <div class="row filter-form">
                        ...
                        <div class="col">
                            <label>By Booking  Date :</label>
                            <input type="text" value="2018/09/01" class="form-control" id="from-date" name="cd">
                        </div>
                        <div class="col"><label> By Checkin Date :</label>
                        <div class="dates"><input type="text" value="2018/09/02" class="form-control" id="to-date" name="cod"></div>
                    </div>
