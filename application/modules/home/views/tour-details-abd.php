...
// var_dump($_SESSION['cart']);
 $item=array('id'=>$_POST['ide'],'sn'=>$_POST['sname'],'cin'=>$_POST['cin'],'cout'=>$_POST['cout'],'type'=>$_POST['type'],'price'=>$_POST['tamount'],'markup'=>$_POST['markup'],'adult'=>$_POST['adult'],'child'=>$_POST['child'],'ttype'=>$_POST['ttype'],'cdate'=>$_POST['cdate']);
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tour Cart</h4>
      </div>
...
echo $night = ceil(abs($end - $start) / 86400);
		   ...
		   <td class=""><?php echo $data['cdate']; ?></td>
                  ...
                  <!--<td align="center"><strong><small>MYR</small> <?php echo  $data['price']+$data['markup']; ?>        </strong></td>-->
				   <td align="right"><strong>MYR <?php echo  $total=$data['price']; 
				   $to=$to+$total;
				   ?>        </strong></td>
        ...
        <div class="col-md-3">
            ...
            <p>
              <button class="btn btn-block btn-primary login" onclick="window.location='tour_cart.php'">Proceed to Payment</button>
            </p>
...
echo $night = ceil(abs($end - $start) / 86400);
        ...
        <div class="col-md-3">
            ...
            <p>
              <button class="btn btn-block btn-primary login" onclick="window.location='tour_cart.php'">Proceed to Payments</button>
            </p>
		  ...
		  <div class="col-md-3">
            ...
            <p>
              <button class="btn btn-block btn-default btn-ghost" data-dismiss="modal">Continue Shoppings</button>
            </p><form name="f" action="" method="POST">
		  ...
		  <div class="col-md-3">
             ...
             <form name="f" action="" method="POST">
			 <p>
              <button class="btn btn-block btn-default btn-ghost" name="empty"  type="submit">Empty Carts</button>
            </p>
          </div>
           <div class="col-md-3 text-right">
        ...
        <div class="col-sm-8">
          <div class="panel panel-default">
			...
			?>
              ...
              <h3 class="heads"><?=$fetch['servicename'];?></h3>
