...
<?php
                    $to='';
        $select_detail=mysql_query("select * from apmg_order_detail_hotel where order_id='$_GET[id]' and cusid='$_SESSION[id]'");
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="col-sm-7">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <h4><li> <?php echo $data['vehicle_name'];?></li></h4>
                            ...
                            <div class="panel-body">
                                <h4 class="project-name">   
                                        ...
                                        <span class="QA_transfer_dateFrom"><?php //echo $data['cd1']; ?></span>-->
                                                ...
                                                <span class="pull-right small"><strong><?php echo"MYR ".number_format(($data['service_price']+$data['markup']),2); ?></strong></span>
                                             </h4>
                               <!-- <p class="alert alert-warning"><i class="fa fa-warning"></i> If the information is not accurate, the supplier is not responsible for the correct service provision.
                                ...
                                <div class="col-sm-6">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>After 23:59 PM on 30/06/2018<span class="pull-right badge">100 %</span> <!--<span class="pull-right badge">53.84 S$</span>--></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="panel-footer clearfix">
