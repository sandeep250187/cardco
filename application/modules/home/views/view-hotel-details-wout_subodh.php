...
//unset($_SESSION['cart']); 
//$_SESSION['cart']= array();
 echo $count_session=count($_SESSION['cart-hotel']);
              ...
              <tbody>
                <tr>
                  ...
                  <th><strong>Checkout</strong></th>
                            <th width="100"><strong>Night</strong></th>
...
echo $night = ceil(abs($end - $start) / 86400);
		   ...
		   <td class=""><?php echo $data['child']; ?></td>
				  ...
				  ?>
                      <li class="product-text"><?php echo $data['room'].' '.$rt.' '.$rc;  ?> <br>
                      </li>
                    </ul></td>
                              
                  
                  <td align="center"><strong><small>MYR</small> <?php echo  $data['price']+$data['markup']; ?>        </strong></td>
				   <td align="right"><strong>MYR <?php echo  $total=($data['price']+$data['markup'])*$data['room']*$night; 
				   $to=$to+$total;
				   ?>        </strong></td>
...
<div class="panel-heading"><a href="#" class="heads text-info" data-toggle="modal" data-target="#room-details"><?php echo $_REQUEST['room']; ?> x Double Room </a></div>
<?php
...
<!-- Room Details Modal -->
<div class="modal fade" id="room-details<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<li class="col-sm-5"><span ><i class="fa fa-gear"></i>  <a href="#" class="heads text-info" data-toggle="modal" data-target="#room-details<?php echo $i; ?>"><?php
													echo $fetrc['roomtype'];
