...
class Products extends CI_Controller{
	...
	function upload()
   {
	...
	function listing($offset=0,$startdate=0,$enddate=0,$specificOption=0,$specificValue=0){			
		...
		$data['pages'] = $this->M_products->listing($limit,$offset,$startdate,$enddate,$specificOption,$specificValue);
		$config['total_rows'] = $this->M_products->count_all($startdate,$enddate,$specificOption,$specificValue);
		/* pagination start */
		$this->load->library('pagination');
		$search_parameter="/$startdate/$enddate/$specificOption/$specificValue";
		$config['first_url'] = site_url("admin/products/listing/0/".$search_parameter);
		$config['suffix']= $search_parameter;
		$config['base_url'] = site_url("admin/products/listing/");
	...
	function view($lead_id=0){
			...
			$this->load->view(ADMIN_FOLDER.'/products/view_products_view',$data);
	...
	function delete($pageid){
		...
		if($this->M_products->delete($pageid))
	...
	function status($id,$status){
		if($this->M_products->status($id,$status))
