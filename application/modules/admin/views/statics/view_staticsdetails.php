      ...
      <section id="main-content">
        ...
        <?php $i=1;?>
				      ...
				      foreach($staticsdetail as $row){ ?>
						...
						<!---edit content---->
						<a class="btn btn-primary btn-xs"  href="<?php echo base_url()."admin/statics/edit/".$row['id'].'/'.$row['static_id'];?>" onclick="return confirm('Are you sure you want to edit <?php echo $row['static_label'] ; ?>?');" title="Edit" ><i class="fa fa-pencil"></i></a>
						<!---end edit Content---->
