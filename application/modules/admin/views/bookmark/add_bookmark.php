		...
		<?php } ?>
                     <h4 class="mb"><i class="fa fa-angle-right"></i> General Information</h4>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo  $this->input->post('video_name'); ?>"  name="faq_title" >
                              </div>
                          </div>
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo  $this->input->post('video_title'); ?>"  name="faq_title" >
                              </div>
                          </div>
			  ...
			  <div class="form-group">
                              ...
                              <div class="col-sm-10">
							  <?php
							echo $this->ckeditor->editor("video_description",$this->input->post('video_description'));
							?>
