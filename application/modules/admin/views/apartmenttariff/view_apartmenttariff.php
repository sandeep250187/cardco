                        ...
                        <tr>
                            ...
                            <td data-title="User Name">
							 ...
							 <td data-title="Event Logo">
                                ...
                                ?> 
                                <a href="<?php echo base_url() ."/uploads/apartmenttariff/".$row['pic1']."";  ?> " target="_blank">
                                <?php echo "<img src='".base_url()."/uploads/apartmenttariff/".$row['pic1']."' width='100px;' height='71px;'>";
                                ?></a>
                                 <?php } ?>
                            </td>
                            ...
                            <td data-title="Action">
                                <!--<a class="btn btn-default btn-xs"  href="<?php echo ADMIN_URL. "apartmenttariff/view/".$row['id']."/".($page-1);?>" title="View" ><i class="fa fa-eye"></i></a>-->
