 ...
 <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Add Room Category</h3>
		...
		<?php } ?>
                     <h4 class="mb"><i class="fa fa-angle-right"></i> General Information</h4>
                              ...
                              <label class="col-sm-2 col-sm-2 control-label">Room Category Name<span class="red_asterisk">*</span></label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" value="<?php echo  $this->input->post('roomCategory'); ?>"  name="roomCategory" >
                              </div>
                          </div>			  
