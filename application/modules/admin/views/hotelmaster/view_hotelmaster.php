...
#results {
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Hotel Master</h3>
                        ...
                        <tr>
							...
							<td data-title="User Name">
							 ...
							 <td data-title="Event Logo">
                                ...
                                ?> 
                                <a href="<?php echo base_url() ."uploads/hotelmaster/".$row['hotel_pic']."";  ?> " target="_blank">
                                <?php echo "<img src='".base_url()."/uploads/hotelmaster/".$row['hotel_pic']."' width='100px;' height='71px;'>";
                                ?></a>
                                 <?php } ?>
                            </td>
                            ...
                            <td data-title="Action">
                                <a class="btn btn-default btn-xs"  href="<?php echo ADMIN_URL. "hoteltariff/view/".$row['id']."/".($page-1);?>" title="View" >View Tariff</a>
                                <a class="btn btn-default btn-xs"  href="<?php echo ADMIN_URL. "hotelmaster/view/".$row['id']."/".($page-1);?>" title="View" ><i class="fa fa-eye"></i></a>
                                    <a class="btn btn-primary btn-xs" href="<?php echo base_url() ."admin/hotelmaster/edit/".$row['id']; ?>" onclick="return confirm('Are you sure you want to edit <?php echo $row['id'] ; ?>?');" title="Edit"><i class="fa fa-pencil"></i></a>
                                                            <!---end edit page---->
                                                            <!---status----->
                                    <?php  if($row['status']==1){?>
                                ...
                                <?php } ?>
                                                                        <!----end status------>
                                 <!----delete------>
                                <a class="btn btn-danger btn-xs" href="<?php echo base_url(). "admin/hotelmaster/delete/".$row['id'];  ?>" onclick="return confirm('Are you sure you want to delete<?php echo $row['id'] ; ?>  ?');" title="Remove"><i class="fa fa-trash-o "></i></a>
                                                                        <!----end delete------>
                            </td>
                        </tr>
                             <?php $i++; } ?>
