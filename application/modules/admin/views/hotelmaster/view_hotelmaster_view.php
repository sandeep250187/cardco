 ...
 <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Hotel Details</h3>
	<button class="btn btn-theme custom_blue_btn" type="button" onclick="window.history.go(-1);" style="float:right;">Go Back</button>
			  ...
			  ?>
                  <?php echo form_open(current_url(), $attributes ); ?>
                     ...
                     <h4 class="mb"><i class="fa fa-angle-right"></i> Hotel Details</h4>
					 
						<div class="form-group">
						  <label class="col-sm-2 col-sm-2 control-label">Hotel Name :</label>
						  <div class="col-sm-10">
						   <?php echo $pages[0]['hotelname']; ?>
						  </div>
						</div>
						...
						<?php echo "<img src='".base_url()."/uploads/hotelmaster/".$pages[0]['hotel_pic']."' width='100px;' height='71px;'>";
						?></a>
						<?php } ?>
					...
					<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">Hotel image gallery : </label>
							<div class="col-sm-10">
							<?php 
																				
						if(!empty($pages[0]['image'])) {
						?> <a href="<?php echo base_url() ."uploads/hotelpicgallery/".$pages[0]['image']."";  ?> " target="_blank">
						<?php echo "<img src='".base_url()."/uploads/hotelpicgallery/".$pages[0]['image']."' width='100px;' height='71px;'>";
						?></a>
						<?php } ?>  
