            ...
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="required form-control" value="<?php echo  $this->input->post('hotelName'); ?>" name="hotelName"> </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Hotel Pic</label>
                        <div class="col-md-10">
                            <input type="file" name="hotel_pic" accept="image/*" class="form-control" value="<?php echo  $this->input->post('hotel_pic'); ?>"> </div>
                    </div>
				  <div class="form-group">
                         <label for="post_name"  class="control-label col-sm-2"> Hotel image gallery</label>
                         <div class="col-sm-10">
            ...
            <tr>
				...
				<div class="form-group" style="margin-top:15px;">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                               echo $this->ckeditor->editor("htl_description");
                            ?>
                        </div>
                    </div>
