...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Edit Search Transfer <button class="btn btn-theme custom_blue_btn" type="button" onclick="window.history.go(-1);" style="float:right;">Go Back</button></h3>
            ...
            <div class="col-lg-12">
                <div class="form-panel">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="required form-control" value="<?php echo $transfers[0]['search_transfer']; ?>"  name="transferSearch"> </div>
                    </div>
					<div class="form-group">
