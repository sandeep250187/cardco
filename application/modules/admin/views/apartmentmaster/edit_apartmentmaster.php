            ...
            <div class="col-lg-12">
                <div class="form-panel">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="required form-control" value="<?php echo $pages[0]['aptname']; ?>" name="aptName"> </div>
                    </div>
					 
                     <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Apartment Pic</label>
                        <div class="col-md-10">
                            <input type="file" name="apt_pic" accept="image/*" class="form-control"  value="<?php echo $pages[0]['apt_pic']; ?>">
							 
                            <?php 
																				
					if(!empty($pages[0]['apt_pic'])) {
						?> <a href="<?php echo base_url() ."uploads/apartmentmaster/".$pages[0]['apt_pic']."";  ?> " target="_blank">
						<?php echo "<img src='".base_url()."uploads/apartmentmaster/".$pages[0]['apt_pic']."' width='60px;' height='60px;'>";
						?>
                        </a>
                        <?php } ?>
                        
                            <input type="hidden" name="apt_img" value="<?php echo $pages[0]['apt_pic']; ?>"> </div>
                    </div>
                   ...
                   <div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" class="required form-control" name="maploc"  ><?php echo $pages[0]['apt_map']; ?></textarea> 
							</div>
                    </div>
					...
					<div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                               echo $this->ckeditor->editor("apt_description",$pages[0]['apt_description']);
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Popular Apartment </label>
                        <div class="col-sm-10">
                            <input type="checkbox" class="required form-control" value="1" <?php if($pages[0]['popular_apt']==1) echo 'checked="checked"'?>"  name="popular_apt"> </div>
                    </div>
