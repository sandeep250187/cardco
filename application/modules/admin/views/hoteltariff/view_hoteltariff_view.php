...
<section id="main-content">	
	...
	{			
    ?>      
	<a href="<?php echo base_url() ."/uploads/hoteltariff/".$row['pic1']."";  ?> " target="_blank">			<?php echo "<img src='".base_url()."/uploads/hoteltariff/".$row['pic1']."' width='100px;' height='71px;'>"; ?>	
	</a>		
	<a href="<?php echo base_url() ."/uploads/hoteltariff/".$row['pic2']."";  ?> " target="_blank">			<?php echo "<img src='".base_url()."/uploads/hoteltariff/".$row['pic2']."' width='100px;' height='71px;'>"; ?>	
	</a>		
	<?php }  ?>		
	</td>							 	
