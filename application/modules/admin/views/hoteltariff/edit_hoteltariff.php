                ...
                <div class="form-panel">
					...
					<div class="form-group">
                     ...
                     <div class="form-group">
                       ...
                       {
						?> <a href="<?php echo base_url() ."uploads/hoteltariff/".$pages[0]['pic1']."";  ?> " target="_blank">
						<?php echo "<img src='".base_url()."/uploads/hoteltariff/".$pages[0]['pic1']."' width='60px;' height='60px;'>";
						?>
                        </a>
                        <?php 
                        }
                        ?>
                            ...
                            <input type="hidden" name="h_img1" value="<?php echo $pages[0]['pic1']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                       ...
                       {
                        ?> <a href="<?php echo base_url() ."uploads/hoteltariff/".$pages[0]['pic2']."";  ?> " target="_blank">
                        <?php echo "<img src='".base_url()."/uploads/hoteltariff/".$pages[0]['pic2']."' width='60px;' height='60px;'>";
                        ?>
                        </a>
                        <?php 
                        }
                        ?>
                            ...
                            <input type="hidden" name="h_img2" value="<?php echo $pages[0]['pic2']; ?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Room Type<span class="red_asterisk">*</span></label>
                        <div class="col-sm-10">
                            <select class="form-control" name="room_type">
                                <option value="">-Select-</option>
                                <option value="Single" <?php if($pages[0]['room_type']=='Single') echo 'selected="selected"'?>>Single</option>
                                <option value="Double" <?php if($pages[0]['room_type']=='Double') echo 'selected="selected"'?>>Double</option>
                                <option value="Triple" <?php if($pages[0]['room_type']=='Triple') echo 'selected="selected"'?>>Triple</option>
                                <option value="Quad" <?php if($pages[0]['room_type']=='Quad')    echo 'selected="selected"'?>>Quad</option>
                           </select>
						</div>
                    </div>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            {
                                ?>
                            <option value="<?=$category['id'];?>" <?php if($pages[0]['room_cat']==$category['id']) echo 'selected="selected"';?>><?=$category['roomtype'];?></option>
                            <?php 
                            }
                            ?>
                           </select>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="required form-control"  name="room_price" value="<?php echo $pages[0]['room_price']; ?>">
							</div>
                    </div>
