...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Add Hotel Room</h3>
        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Select Hotel<span class="red_asterisk">*</span></label>
                        <div class="col-sm-10">
                            <select class="required form-control"   name="hotelid">
                                <option value="">-Select Hotel-</option>
                                <?php
                            $HotelId = getHotelList();
                            foreach($HotelId as $hotel)
                            {
                            echo "<option value=".$hotel['id'].">".$hotel['hotelname']."</option>";
                            }
                            ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                         <label for="post_name"  class="control-label col-sm-2"> Room image gallery</label>
                         <div class="col-sm-10">
            ...
            <tr>
                ...
                <div class="form-group" style="margin-top:15px;">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-10">
                           <select class="form-control" name="room_cat">
                            ...
                            {
                            echo "<option value=".$category['id'].">".$category['roomtype']."</option>";
                            }
                            ?>
						   </select>
						</div>
					...
					<div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Room Price<span class="red_asterisk">*</span></label>
                        <div class="col-sm-10">
                            <input type="text" class="required form-control" value="<?php echo  $this->input->post('room_price'); ?>" name="room_price">
							</div>
                    </div>	
