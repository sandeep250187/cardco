      ...
      <section id="main-content">
              ...
              <div class="col-lg-12">
                      <div class="content-panel">
						...
						<div class="form-group" align="left">
							...
							<button class="btn btn-theme custom_blue_btn" type="reset" onclick="window.location='<?php echo base_url() ?>supplier/album/listing';" name="search">Reset</button>
						</div>
						<?php echo form_close(); ?>
        ...
        <?php $i=++$page;?>
					  ...
					  ?>
						...
						<td data-title="Email">
						<a class="btn btn-default btn-xs"  href="<?php echo base_url() . "supplier/album/view/".$row['id']; ?>" title="View" ><i class="fa fa-eye"></i></a>
						<!---edit page---->
						<a class="btn btn-primary btn-xs"  href="<?php echo base_url() . "supplier/album/edit/".$row['id']; ?>" onclick="return confirm('Are you sure you want to edit <?php echo $row['album_title'] ; ?>?');" title="Edit" ><i class="fa fa-pencil"></i></a>
						<!---end edit page---->
						<!----delete------>
