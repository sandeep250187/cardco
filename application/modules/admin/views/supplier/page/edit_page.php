		...
		<?php } ?>
                     <h4 class="mb"><i class="fa fa-angle-right"></i> General Information</h4>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $pages[0]['page_title']; ?>"  name="page_title" >
                              </div>
                          </div>
			<div class="form-group">
			  <label class="col-sm-2 col-sm-2 control-label">Page Banner</label>
					<div class="col-md-10"><input type="file" name="image_file" accept="image/*" class="form-control">
					<?php 
					if(!empty($pages[0]['image_file'])) {
						echo "<img src='".base_url()."/uploads/".$pages[0]['image_file']."' width='300px;' height='40px;'>";
					} ?>
					<input type="hidden" name="h_img" value="<?php echo $pages[0]['image_file']; ?>">
					</div> 
          					
		    </div>
			  
			  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Page Content<span class="red_asterisk">*</span></label></label>
                              <div class="col-sm-10">
							  <?php
							echo $this->ckeditor->editor("content",$pages[0]['page_content']);
							?>
                           </div>
                </div>
				<div class="form-group">
                              ...
                              <div class="col-sm-10">
							  <?php
							echo $this->ckeditor->editor("tablet_content",$pages[0]['tablet_content']);
							?>
				 ...
				 <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $pages[0]['page_slug']; ?>"  name="page_slug" >
			   ...
			   <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" value="<?php echo $pages[0]['meta_title']; ?>"  name="meta_title" >
                              </div>
                          </div>
			  ...
			  <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $pages[0]['meta_description']; ?>"  name="meta_description" >
                              </div>
                          </div>
			 <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Meta keyword</label>
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $pages[0]['meta_keyword']; ?>"  name="meta_keyword" >
