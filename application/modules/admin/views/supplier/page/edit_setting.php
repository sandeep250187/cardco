      ...
      <section id="main-content">
		...
		<?php } ?>
                     <h4 class="mb"><i class="fa fa-angle-right"></i> General Information</h4>
			              ...
			              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">supplier Email<span class="red_asterisk">*</span></label>
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $pages['supplier_email']; ?>"  name="supplier_email" >
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">supplier Contact<span class="red_asterisk">*</span></label>
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo $pages['supplier_contact']; ?>"  name="supplier_contact" >
                              </div>
                          </div>
