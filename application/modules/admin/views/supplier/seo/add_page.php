 ...
 <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Add SEO Page</h3>
			  ...
			  <?php $attributes = array('class' => 'form-horizontal style-form input_from_custom', 'id' => 'seo-form', 'name' => 'seo-form' ,'enctype'=>'multipart/form-data' ); ?>
		...
		<?php } ?>
                    ...
                    <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="required form-control" value="<?php echo  $this->input->post('main_url'); ?>"  name="main_url" >
                              </div>
                          </div>
				 ...
				 <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" value="<?php echo  $this->input->post('sub_url'); ?>"  name="sub_url" >
								  <span class="user-message">Enter * for use Main Url for pages.</span>
                              </div>
                          </div>
			  
			   <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Meta Title<span class="red_asterisk">*</span></label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control required" value="<?php echo  $this->input->post('meta_title'); ?>"  name="meta_title" >
                              </div>
                          </div>
