				 ...
				 <?php 				
				  ...
				  ?>
					...
					<td data-title="Last Name"> <?php echo globalDateformat($row['video_date']); ?></td>
						...
						<a class="btn btn-default btn-xs"  href="<?php echo base_url() . "supplier/video/view/".$row['v_id']."/".($page-1); ?>" title="View" ><i class="fa fa-eye"></i></a>
						<!---edit page---->
						<a class="btn btn-primary btn-xs"  href="<?php echo base_url() . "supplier/video/edit/".$row['v_id']."/".$row['video_lang']."/".($page-1); ?>" onclick="return confirm('Are you sure you want to edit <?php echo $row['video_title'] ; ?>?');" title="Edit" ><i class="fa fa-pencil"></i></a>
						<!---end edit page---->
						<!---status----->
						...
						<!----delete------>
						<a class="btn btn-danger btn-xs" href="<?php echo base_url() . "supplier/video/delete/".$row['v_id'].'/'.$row['video_lang'];  ?>" onclick="return confirm('Are you sure you want to remove this video?');" title="Remove"><i class="fa fa-trash-o "></i></a>
						<!---- end delete ------>
						</td>
                                  </tr>
				      <?php $i++; } ?>
