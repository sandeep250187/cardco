 ...
 <!--main content start-->
      <section id="main-content">
              ...
              <div class="col-lg-12">
                      <div class="content-panel">
						...
						<div class="form-group" align="left">
						 ...
						 <div align="right"><a href="<?php echo SUPPLIER_URL. "leads/download/$dateFrom/$dateTo/$source/$servey/$full_name"; ?>" class="btn btn-theme custom_blue_btn">Export Leads</a></div>
						<?php echo form_close(); ?>
        ...
        <?php $i=++$page;?>
			...
			<?php 
			$deleteUrl = SUPPLIER_URL. "leads/delete/".$row['id']."/".($page-1);
			?>
					    
						<a class="btn btn-default btn-xs"  href="<?php echo SUPPLIER_URL. "leads/view/".$row['id']."/".($page-1);?>" title="View" ><i class="fa fa-eye"></i></a>
