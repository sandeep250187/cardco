 ...
 <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
			...
			?>
              ...
              <div class="col-lg-12">
				...
				<td data-title="View">
				<a class="btn btn-primary btn-xs view"  href="<?php echo site_url(); ?>supplier/exvideo/view?pid=<?php echo $row->id->playlistId;?>&p=first" target="_blank" title="View"><i class="fa fa-eye"></i></a>
				</td>
						  </tr>
				      <?php 
					  $i++; 
	   ...
	   if(!empty($prevPageToken)){
		   $link_nav = site_url().'supplier/exvideo?cid='.$channel_id.'&prev='.$prevPageToken;
		   echo "<a href='".$link_nav."'>Prev</a>";
	   }
	   if(!empty($nextPageToken)){
		   $link_nav = site_url().'supplier/exvideo?cid='.$channel_id.'&next='.$nextPageToken;
