 ...
 <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="errormsg" style="color:green;text-align: center;">supplier setting changed Sucessfully!.</div>
               <?php } ?>
		...
		<?php } ?>
                     <h4 class="mb"><i class="fa fa-angle-right"></i> General Information</h4>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"><label>supplier Email</label><span class="red_asterisk">*</span></label>
                              <div class="col-sm-10">
                                  <input style="width: 210px;" type="text" placeholder="Enter supplier Email" class="required form-control" size="20" id="supplier_email" required="required" name="supplier_email" value="<?php echo $setting->supplier_email; ?>">
                              </div>
                          </div>
