 ...
 <!--main content start-->
      <section id="main-content">
        ...
        <tr>
		  ...
		  <tr><td colspan="4"><div align="center"><a href="<?php echo base_url()."/admin/member/addcredit/".$this->uri->segment(4); ?>" class="btn btn-theme custom_blue_btn">Add User Credit</a> </div></td></tr>
				  <?php } else { ?>
        <tr>
