...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Edit Apartment Category <button class="btn btn-theme custom_blue_btn" type="button" onclick="window.history.go(-1);" style="float:right;">Go Back</button></h3>
                ...
                <div class="form-panel">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="required form-control"  name="apartmentCategory" value="<?php echo $pages[0]['aptcat'];?>"> </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Apartment Category<span class="red_asterisk">*</span></label>
                        <div class="col-sm-10">
<?php
  ...
  echo form_dropdown('aptcap',$option,$pages[0]['aptcap'], $attr);
?>
                        </div>
                    </div>                    
                     <div class="form-group">
