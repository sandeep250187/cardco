				      ...
				      foreach($pages as $row){   //print_r($row); ?>
                                                    <tr>
													  ...
													  <td>
														...
														<a href="<?php echo base_url(). "admin/order";  ?>/viewdetail/<?php echo $row['id']; ?>" title="View Detail & Approve"><i class="fa fa-eye"></i></a> &nbsp;&nbsp;&nbsp;
                                                                                    
                                                         <a class="btn btn-danger btn-xs" href="<?php echo base_url(). "admin/order/delete/".$row['id'];  ?>" onclick="return confirm('Are you sure you want to remove this page?');" title="Remove"><i class="fa fa-trash-o "></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php $i++; } ?>
                                            </tbody>
