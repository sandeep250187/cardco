        ...
        <?php $i=++$page;?>
				      ...
				      foreach($pages as $row){ ?>
				       ...
				       <td data-title="Description"><?php $content=strip_tags($row['page_content']); echo substr($content,0,100)." ....."; ?></td>
						...
						<!---edit page---->
						<a class="btn btn-primary btn-xs"  href="<?php echo base_url()."admin/page/edit/".$row['id'];?>" onclick="return confirm('Are you sure you want to edit <?php echo $row['page_title'] ; ?>?');" title="Edit" ><i class="fa fa-pencil"></i></a>
						<!---end edit page---->
						<!---status----->
						<?php  if($row['status']==1){?>
