			...
			?>
              ...
              <div class="col-lg-12">
				  ...
				  ?>
				       ...
				       <td data-title="Admin Email"><?php echo $setting['admin_email']; ?></td>
                       <td data-title="Admin Contact"><?php echo $setting['admin_contact']; ?></td>        					  
						<td data-title="Action">
						<!---edit page---->
						<a class="btn btn-primary btn-xs"  href="<?php echo base_url()."admin/setting/edit/".$setting['id'];?>" onclick="return confirm('Are you sure you want to edit <?php echo $setting['clinic_name'] ; ?>?');" title="Edit" ><i class="fa fa-pencil"></i></a>
						<!---end edit page---->
						</td>
                                  </tr>
                                  </tbody>
