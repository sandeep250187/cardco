 ...
 <!--main content start-->
      <section id="main-content">
        ...
        <?php $i=++$page;?>
			...
			<?php 
			$deleteUrl = ADMIN_URL. "contactcredit/delete/".$row['id']."/".($page-1);
			?>
					    
						<a class="btn btn-default btn-xs"  href="<?php echo ADMIN_URL. "contactcredit/view/".$row['id']."/".($page-1);?>" title="View" ><i class="fa fa-eye"></i></a>
