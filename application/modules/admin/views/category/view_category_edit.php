...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Edit Category <button class="btn btn-theme custom_blue_btn" type="button" onclick="window.history.go(-1);" style="float:right;">Go Back</button></h3>
            ...
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="required form-control" value="<?php echo $pages[0]['cat_name']; ?>" name="cat_name"> </div>
                    </div>
					...
					if(!empty($pages[0]['file_name'])) {
						?> <a href="<?php echo base_url() ."uploads/category/".$pages[0]['file_name']."";  ?> " target="_blank">
						<?php echo "<img src='".base_url()."/uploads/category/".$pages[0]['file_name']."' width='60px;' height='60px;'>";
						?>
                        </a>
                        <?php } ?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
							echo $this->ckeditor->editor("cat_desc",$pages[0]['cat_desc']);
							?>
                        </div>
                    </div>
					<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
							echo $this->ckeditor->editor("cat_sub_desc",$pages[0]['cat_sub_desc']);
							?>
                        </div>
                    </div>
