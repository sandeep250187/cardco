				 ...
				 <?php $i=++$page;?>
                    <tbody>
				      ...
				      <!-- <td data-title="Action">
					    ...
					    <a class="btn btn-primary btn-xs"  href="<?php echo base_url() . "admin/keyword/edit/".$row['catid']."/".($page-1);?>" onclick="return confirm('Are you sure you want to edit <?php echo $row['cat_name']; ?>?');" title="Edit" ><i class="fa fa-pencil"></i></a>
					    
					   <a class="btn btn-danger btn-xs" href="<?php echo base_url() . "admin/keyword/delete/".$row['catid']."/".($page-1);?>" onclick="return confirm('Are you sure you want to remove <?php echo $row['cat_name']; ?>?');"  title="Remove"><i class="fa fa-trash-o "></i></a>
				      </td>-->
                                  </tr>
				      <?php $i++; } ?>
                                  </tbody>
