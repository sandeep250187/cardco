 ...
 <!--main content start-->
      <section id="main-content">
		...
		?>		
              ...
              <div class="col-lg-12">
                      <div class="content-panel">
						...
						<div class="form-group" align="left">
							...
							<button class="btn btn-theme custom_blue_btn" type="reset" onclick="window.location='<?php echo base_url() ?>admin/album/gallery';" name="search">Reset</button>
						</div>
						<?php echo form_close(); ?>
			...
			<a class="btn btn-primary btn-xs"  href="<?php echo ADMIN_URL. "album/image/".$row['id']."/".($page-1);?>" title="View" ><i class="fa fa-eye"></i></a>
