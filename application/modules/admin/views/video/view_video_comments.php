				...
				<?php $i=++$page;?>
                      ...
                      <tr>
				       ...
				       <td data-title="Last Name"><?php $content=strip_tags($row['video_description']); echo substr($content,0,50)." ....."; ?></td>
						...
						<td data-title="Email">
						<!---edit page---->
						<a class="btn btn-primary btn-xs"  href="<?php echo base_url() . "admin/video/edit/".$row['v_id']; ?>" onclick="return confirm('Are you sure you want to edit <?php echo $row['video_title'] ; ?>?');" title="Edit" ><i class="fa fa-pencil"></i></a>
						<!---end edit page---->
						<!---status----->
						...
						<!----delete------>
						<a class="btn btn-danger btn-xs" href="<?php echo base_url() . "admin/video/delete/".$row['v_id'];  ?>" onclick="return confirm('Are you sure you want to remove this video?');" title="Remove"><i class="fa fa-trash-o "></i></a>
						<!---- end delete ------>
						</td>
                       </tr>
				      <?php $i++; } ?>
