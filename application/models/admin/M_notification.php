...
class M_notification extends CI_Model{
	private $tbl_payment_criteria = 'tbl_notification';
	 ...
	 function checkusername($username)
  {
   ...
   { 
	...
	function delete($pageid){
	    ...
	    $link=base_url().'uploads/notification/'.$result['logo'];
	    unlink($link);
	
		
		$this->db->delete('tbl_notification', array('id' => $pageid));
...
function Updatepriority($id,$priority)
 ...
 //extensive suitability check before doing anything with the file...
    ...
    else if (!is_uploaded_file($_FILES['upload']["tmp_name"]))
    {
      ...
      $url = $fdata[0]."uploads/notification/" . $time."_".$_FILES['upload']['name'];
    }
